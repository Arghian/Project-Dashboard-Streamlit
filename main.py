# -*- coding: utf-8 -*-
"""Dashboard Arghian Faizal Y.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1HFsMTjv2BO5mUeEvNvvU0AgIwqlSmKFy
"""
...
# Title
st.header("E-Commerce Dashboard :Convenience Store Brazil")

# Sidebar
with st.sidebar:
    # Title
    st.title("Arghian Faizal Y.")
...
st.caption('Copyright (C) Arghian Faizal Y. 2024')
